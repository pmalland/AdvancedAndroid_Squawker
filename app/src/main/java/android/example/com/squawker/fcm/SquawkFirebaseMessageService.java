...
public class SquawkFirebaseMessageService extends FirebaseMessagingService {
     ...
     *            NOTE tha it has to be a FINAL to be used in the thread
     */
    private void insertSquawk(final Map<String,String> data){

        // Database operations should not be done on the main thread
        // So we define an AsynkTask live style
        // Remember, the name of an AsynkTask ends ...with Task ...
    ...
    private void sendNotification(Map<String,String> data){
        ...
        //gather the data we need for the notification
        ...
        //Building the notification with a Builder from NotificationCompat
        ...
        // and now fiund and call the notification manager to notify

        NotificationManager notificationManager =
                (NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);

        notificationManager.notify(0 /* ID of the notification*/ , notificationBuilder.build());
